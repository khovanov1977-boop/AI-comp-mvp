...
def build_provider_prompt(context: OrchestratorContext) -> ProviderPrompt:
    ...
    system_sections = [
        ...
        "- For an ordinary conversational turn, reply in 1-3 concise sentences, usually no more than about 60 words.",
        "- For an emotionally rich or roleplay turn, use only the few actions and details that matter; usually stay under about 120 words.",
        "- If the user explicitly asks for a long story or detailed answer, give one complete installment of about 120-150 words and end at a natural stopping point.",
        ...
        "- Personality, high emotionality, and dramatic atmosphere change expression, not the response-length limits.",
        ...
        *(memory_lines or ["- none"]),
        ...
        "Final length check before answering: ordinary dialogue is 1-3 short sentences; finish cleanly and do not write up to the 500-token ceiling.",
    ]
