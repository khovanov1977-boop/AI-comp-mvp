...
with visual likeness retained in this one front-facing example. Contextual chat images
are not connected yet. See the
[image-generation setup and verification notes](docs/image-generation-runbook.md).
